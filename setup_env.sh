...
NATIVE_LIB="ON"
COMMON_OPT="-DCMAKE_CXX_COMPILER=clang++ -DCMAKE_C_COMPILER=clang -DACCURACY_TEST=ON -DCMAKE_INSTALL_PREFIX=${DDPROF_INSTALL_PREFIX} -DBUILD_BENCHMARKS=${DDPROF_BUILD_BENCH} -DBUILD_NATIVE_LIB=${NATIVE_LIB}"

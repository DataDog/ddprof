...
//(PERF_SAMPLE_TID|PERF_SAMPLE_TIME|PERF_SAMPLE_PERIOD|PERF_SAMPLE_REGS_USER|PERF_SAMPLE_STACK_USER)
//#define DEFAULT_SAMPLE_TYPE
//(PERF_SAMPLE_IP|PERF_SAMPLE_TID|PERF_SAMPLE_TIME|PERF_SAMPLE_ADDR|PERF_SAMPLE_CALLCHAIN|PERF_SAMPLE_CPU|PERF_SAMPLE_PERIOD|PERF_SAMPLE_RAW|PERF_SAMPLE_REGS_USER|PERF_SAMPLE_STACK_USER|PERF_SAMPLE_DATA_SRC)
#define DEFAULT_SAMPLE_TYPE                                                    \

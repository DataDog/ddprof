...
inline constexpr const char *k_profiler_lib_env_variable =
...
inline constexpr const char *k_libdd_profiling_embedded_name =
    "libdd_profiling-embedded.so";

inline constexpr const char *k_libdd_loader_name = "libdd_loader.so";

inline constexpr const char *k_profiler_exe_name = "ddprof";

...
# Set C/C++ standard on a ddprof target. Per-target properties override any global or
# toolchain-injected standard, so ddprof builds correctly even when embedded in a parent project
# that uses a different C++ standard (e.g. Conan with C++23).
...
# Wrapper around add_library that also sets the ddprof C/C++ standard.
function(ddprof_add_library name)
...
function(target_strip_debug_info target)
  if(STRIP_DEBUG_INFO)
    target_link_options(${target} PRIVATE "LINKER:--strip-debug")
  endif()
endfunction()

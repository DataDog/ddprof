...
#define PERFTOOLS__PROFILES__PROFILE__INIT                                     \
  {                                                                            \
    ...
    , 0, NULL, 0, NULL, 0, NULL, 0, NULL, 0, NULL, 0, NULL, 0, 0, 0, 0, NULL,  \
        0, 0, NULL, 0                                                          \
  }
...
typedef void (*Perftools__Profiles__Profile_Closure)(
    const Perftools__Profiles__Profile *message, void *closure_data);
typedef void (*Perftools__Profiles__ValueType_Closure)(
    const Perftools__Profiles__ValueType *message, void *closure_data);
typedef void (*Perftools__Profiles__Sample_Closure)(
    const Perftools__Profiles__Sample *message, void *closure_data);
typedef void (*Perftools__Profiles__Label_Closure)(
    const Perftools__Profiles__Label *message, void *closure_data);
typedef void (*Perftools__Profiles__Mapping_Closure)(
    const Perftools__Profiles__Mapping *message, void *closure_data);
typedef void (*Perftools__Profiles__Location_Closure)(
    const Perftools__Profiles__Location *message, void *closure_data);
typedef void (*Perftools__Profiles__Line_Closure)(
    const Perftools__Profiles__Line *message, void *closure_data);
typedef void (*Perftools__Profiles__Function_Closure)(
    const Perftools__Profiles__Function *message, void *closure_data);
...
extern const ProtobufCMessageDescriptor
    perftools__profiles__profile__descriptor;
extern const ProtobufCMessageDescriptor

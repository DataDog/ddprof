...
Download the latest ddprof binary from http://binaries.ddbuild.io/ddprof/release/ddprof

Refer to docs/Commands.md for the commands supported in the contemporary ddprof.  This document is autogenerated, so it should be contemporary to the release.
